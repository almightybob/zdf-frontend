		...
		<div class="flex-1">
			<a class="text-xl flex flex-row justify-items-center align-middle" href="/">
				<svg version="1.1" id="svg868" width="80" height="70" viewBox="0 0 256 185">
					...
					<g
						id="g20"
						transform="matrix(0.32819664,-0.1242044,0.1242044,0.32819664,84.7031,165.62745)"
						style="opacity:1"
					>
						<defs id="defs16" class="defs" />
						<path
							id="path18"
							class="color c1"
							d="m 500,60.923 c 0,0 -57.629,-85.347 -230.516,-9.33 C 96.323,107.849 0,0 0,0 0,0 37.871,83.15 132.272,109.222 218.715,133.095 279.912,95.499 361.416,65.587 438.255,37.597 500,60.923 500,60.923 Z"
							inkscape:connector-curvature="0"
							style="fill:#8e1a1a"
						/>
					</g>
					<g id="g30" transform="matrix(0.37584099,0,0,0.37584099,0,132.2695)" style="opacity:1">
						<defs id="defs22" class="defs" />
						<g id="g28">
							<g id="g26">
								<path
									id="path24"
									class="color c1"
									d="M 0,74.454 C 0,74.454 17.224,3.76 121.08,0.161 224.936,-3.181 249.101,46.433 335.733,55.174 422.108,63.914 500,0.161 500,0.161 c 0,0 -73.008,99.485 -183.805,97.172 C 205.398,95.02 132.391,3.76 0,74.454 Z"
									inkscape:connector-curvature="0"
									style="fill:#8e1a1a"
								/>
							</g>
				...
				<div class="flex p-4">
					<p class="text-2xl font-display font-bold">Zentrum der Fülle</p>
				</div></a
			>
		</div>
		<div class="flex-none">
